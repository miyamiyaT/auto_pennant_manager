...
export const buildPlayerSeasonPayload = (
  ...
  is_starter: form.is_starter ? Boolean(form.is_starter) : false,
  is_relief: form.is_relief ? Boolean(form.is_relief) : false,
  is_closer: form.is_closer ? Boolean(form.is_closer) : false,
  is_catcher: form.is_catcher ? Boolean(form.is_catcher) : false,
  is_first: form.is_first ? Boolean(form.is_first) : false,
  is_second: form.is_second ? Boolean(form.is_second) : false,
  is_third: form.is_third ? Boolean(form.is_third) : false,
  is_short: form.is_short ? Boolean(form.is_short) : false,
  is_outfielder: form.is_outfielder ? Boolean(form.is_outfielder) : false,
